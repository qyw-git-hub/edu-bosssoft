...
import wStepExhibit from "./components/step/exhibit.vue";
...
const components = [wTitle, wAlert, wSwitch, wTable, wDialog, filedView, wTreeSelectMult, wTreeSelectSingle, multipleLeft, multiInput, treeMultipleDialog, formItemGeneratorGoods, exmineWithProcess, wExmine, svgIcon, wStep, wStepExmine, wStepExhibit, selectLong, weekSelect, wCollapseButtons];
...
// 导出单个组件
export { wTitle, wAlert, wSwitch, wTable, wDialog, filedView, wTreeSelectMult, wTreeSelectSingle, multipleLeft, multiInput, treeMultipleDialog, formItemGeneratorGoods, exmineWithProcess, wExmine, svgIcon, wStep, wStepExmine, wStepExhibit, selectLong, weekSelect, wCollapseButtons };
